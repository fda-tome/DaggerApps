#!/bin/bash -l
#PBS -A dagger
#PBS -N barnes_scaling
#PBS -q prod
#PBS -l select=256
#PBS -l walltime=06:00:00
#PBS -l filesystems=flare
#PBS -l place=scatter
#PBS -o /lus/flare/projects/dagger/paper/DaggerApps/benchmarks/results/barnes-hut/pbs/barnes_scaling.out
#PBS -e /lus/flare/projects/dagger/paper/DaggerApps/benchmarks/results/barnes-hut/pbs/barnes_scaling.err
